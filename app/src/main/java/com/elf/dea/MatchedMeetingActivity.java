...
public class MatchedMeetingActivity extends AppCompatActivity {
    int position;
    ...
    TextView name, datetime, location, restName , eatType, meetpr, interestText, resultText;
    ImageView imageView;
    TextView creator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matched_meeting);
        ...
        resultText.setText("%" + Integer.toString(result.get(position)));
        System.out.println("RESULT : "+ result.get(position));
    ...
    public void join(View view){
        ...
        firebaseFirestore.collection("Meetings").document(creator).collection("Participants")
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(MatchedMeetingActivity.this,e.getLocalizedMessage().toString(),Toast.LENGTH_LONG).show();
        ...
        firebaseFirestore.collection("Users").document(firebaseAuth.getCurrentUser().getEmail()).collection("Meetings I've joined")
            ...
            public void onSuccess(DocumentReference documentReference) {
                System.out.println("Participant: " + firebaseAuth.getCurrentUser().getEmail() + " added to: " + meetingNameFromDB.get(position));
                AlertDialog alertDialog = new AlertDialog.Builder(MatchedMeetingActivity.this).create();
